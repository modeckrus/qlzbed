...
class DescriptionViewWidget extends StatefulWidget {
  ...
  DescriptionViewWidget({Key key, @required this.descPath}) : super(key: key);

  @override
  _DescriptionViewWidgetState createState() => _DescriptionViewWidgetState();
}
        ...
        child: Column(
          children: [
            Container(
              ...
              child: SingleChildScrollView(child: QlzbView(document: document)),
            ),
            isShort
                ? ListTile(
                    title: Row(
