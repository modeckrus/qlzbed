...
class ModerateAddTestsPage extends StatefulWidget {
  final DocumentSnapshot doc;
  final String filepath;
  final List<TestBase> tests;
  const ModerateAddTestsPage(
      {Key key,
      @required this.doc,
      ...
      : super(key: key);
  @override
  _ModerateAddTestsPageState createState() => _ModerateAddTestsPageState();
}

class _ModerateAddTestsPageState extends State<ModerateAddTestsPage> {
  Function onPressed;
  ModerationTests article;
  ...
  void initState() {
    ...
    article = ModerationTests.fromJson(widget.doc.data);
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              MyIcons.moderation,
              Text(AppLocalizations.of(context).titleModerateAddTests),
            ],
          ),
        ),
        body: BlocProvider(
  ...
  Future<void> _addTests() async {
    try {
      ...
      final narticle = ModerationTests(
