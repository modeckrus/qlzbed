...
///
/// Represents a segment of a QDoc document with specified [offset]
/// and [length].
///
...
abstract class ContainerNode<T extends Node> extends Node {
  ...
  @override
  void retain(int index, int length, QDocStyle attributes) {
    assert(isNotEmpty);
...
abstract class StyledNodeMixin implements StyledNode {
  @override
  QDocStyle get style => _style;
  QDocStyle _style = QDocStyle();

  /// Applies style [attribute] to this node.
  void applyAttribute(QDocAttribute attribute) {
