...
/// A leaf node in QDoc document tree.
abstract class LeafNode extends Node
  ...
  void formatAndOptimize(QDocStyle style) {
  ...
  @override
  void applyStyle(QDocStyle value) {
    assert(value != null && (value.isInline || value.isEmpty),
        'Style cannot be applied to this leaf node: $value');
    assert(() {
      if (value.contains(QDocAttribute.embed)) {
        if (value.get(QDocAttribute.embed) == QDocAttribute.embed.unset) {
  ...
  @override
  void insert(int index, String value, QDocStyle style) {
...
/// A span of formatted text within a line in a QDoc document.
///
...
/// An embed node inside of a line in a QDoc document.
///
