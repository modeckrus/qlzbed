...
/// Core widget responsible for editing Qlzb documents.
///
/// Depends on presence of [QlzbTheme] and [QlzbScope] somewhere up the
/// widget tree.
///
/// Consider using [QlzbEditor] which wraps this widget and adds a toolbar to
/// edit style attributes.
class QlzbEditableText extends StatefulWidget {
  const QlzbEditableText({
    Key key,
  ...
  @override
  _QlzbEditableTextState createState() => _QlzbEditableTextState();
}

class _QlzbEditableTextState extends State<QlzbEditableText>
  ...
  QDocDocument get document => widget.controller.document;
  ...
  Widget build(BuildContext context) {
    ...
    layers.add(QlzbSelectionOverlay(
  ...
  @override
  void didUpdateWidget(QlzbEditableText oldWidget) {
  ...
  void _updateSubscriptions([QlzbEditableText oldWidget]) {
    if (oldWidget == null) {
