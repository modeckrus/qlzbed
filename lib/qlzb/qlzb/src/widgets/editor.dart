...
/// Widget for editing Qlzb documents.
class QlzbEditor extends StatefulWidget {
  const QlzbEditor({
    Key key,
  ...
  @override
  _QlzbEditorState createState() => _QlzbEditorState();
}

class _QlzbEditorState extends State<QlzbEditor> {
  QlzbImageDelegate _imageDelegate;
  QlzbScope _scope;
  QlzbThemeData _themeData;
  GlobalKey<QlzbToolbarState> _toolbarKey;
  QlzbScaffoldState _scaffold;
  ...
  @override
  void didUpdateWidget(QlzbEditor oldWidget) {
  ...
  void didChangeDependencies() {
    ...
    final scaffold = QlzbScaffold.of(context);
  ...
  Widget build(BuildContext context) {
    ...
    Widget editable = QlzbEditableText(
