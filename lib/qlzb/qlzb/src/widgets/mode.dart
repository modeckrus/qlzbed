...
/// Controls level of interactions allowed by Qlzb editor.
///
...
class QlzbMode {
  ...
  static const edit = QlzbMode(canEdit: true, canSelect: true, canFormat: true);
  ...
  /// Creates new mode which describes allowed interactions in Qlzb editor.
  const QlzbMode({
  ...
  bool operator ==(Object other) {
    ...
    if (other is! QlzbMode) return false;
    final QlzbMode that = other;
  ...
  @override
  String toString() {
    return 'QlzbMode(canEdit: $canEdit, canSelect: $canSelect, canFormat: $canFormat)';
  }
}
