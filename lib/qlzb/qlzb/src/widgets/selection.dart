...
class QlzbSelectionOverlay extends StatefulWidget {
  const QlzbSelectionOverlay({Key key, @required this.controls})
      : super(key: key);

  final TextSelectionControls controls;

  @override
  QlzbSelectionOverlayState createState() => QlzbSelectionOverlayState();
}

class QlzbSelectionOverlayState extends State<QlzbSelectionOverlay>
  ...
  @override
  void didUpdateWidget(QlzbSelectionOverlay oldWidget) {
...
class SelectionHandleDriver extends StatefulWidget {
  ...
  final QlzbSelectionOverlayState selectionOverlay;
...
class _SelectionToolbarState extends State<_SelectionToolbar> {
  ...
  QlzbScope get scope => widget.selectionOverlay.scope;
