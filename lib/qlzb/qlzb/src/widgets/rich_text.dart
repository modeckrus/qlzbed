...
/// Represents single paragraph of Qlzb rich-text.
class QlzbRichText extends LeafRenderObjectWidget {
  QlzbRichText({
    @required this.node,
    @required this.text,
  ...
  void updateRenderObject(
      BuildContext context, RenderQlzbParagraph renderObject) {
    renderObject
      ..text = text
      ..node = node;
  }
...
class RenderQlzbParagraph extends RenderParagraph implements RenderEditableBox {
  RenderQlzbParagraph(
    TextSpan text, {
