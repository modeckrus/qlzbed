...
/// Holds colors and typography values for a Qlzb design theme.
///
/// To obtain the current theme, use [QlzbTheme.of].
@immutable
class QlzbThemeData {
  /// Default theme used for document lines in Qlzb editor.
  ///
  ...
  /// Creates a [QlzbThemeData] given a set of exact values.
  const QlzbThemeData({
  ...
  /// Creates a new [QlzbThemeData] where each property from this object has
  ...
  bool operator ==(other) {
    ...
    final QlzbThemeData otherData = other;
...
/// Holds typography values for a document line in Qlzb editor.
///
...
/// Holds typography values for a block of lines in Qlzb editor.
@immutable
class BlockTheme {
...
/// Holds style information for all format attributes supported by Qlzb editor.
@immutable
...
/// Defines styles and colors for Qlzb editor toolbar.
class ToolbarTheme {
